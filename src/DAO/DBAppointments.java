...
public class DBAppointments {
    ...
    public static void setAllAppointments() throws SQLException {
        ...
        String selectStatement = "SELECT Appointment_ID, Title, Description, Location, contacts.Contact_Name, Type, Start, End, appointments.Customer_ID, appointments.User_ID "
        ...
        while (rs.next()) {
            ...
            // create a new Appointment object, using the above variables to define it's fields
            Appointment appt = new Appointment(apptId, title, description, location, contact, type, start, end, customerId, userId);
