...
//        Uncomment below line to test French translation of login panel
//        Locale.setDefault(Locale.FRENCH);
        ...
        ResourceBundle frrb = ResourceBundle.getBundle("SchedulingApp/Natlang", Locale.getDefault());

        loginLabel.setText(frrb.getString("Login"));
        userField.setPromptText(frrb.getString(userField.getPromptText()));
        passField.setPromptText(frrb.getString(passField.getPromptText()));
        submitButton.setText(frrb.getString("Submit"));
     ...
     */
    public void submitButtonHandler(ActionEvent event) throws IOException, SQLException {
        // User login entries
        ...
        errorLabel.setText(frrb.getString("error"));
    }
