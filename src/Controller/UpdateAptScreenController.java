...
/**
 ...
 @author Sean
 */
public class UpdateAptScreenController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        userField.setItems(DBUsers.getAllUsers());
    ...
    /**
     ...
     retrieved from the user's previously selected Appointment. These values are pre-populated into their respective data fields to allow the user to make
    ...
    public void initializeFields() {
        ...
        typeField.setText(selectedApt.getType());
        ...
        userField.getSelectionModel().select(selectedApt.getUser(selectedApt.getUserId()));
    ...
    public boolean validateFields() {
        ...
        // Location
            ...
            return false;
                   ...
                   isNumber(typeField.getText())) {
            
            errorText.setText("Type field input invalid.");
            return false;
            ...
            return false;
        } else if (userField.getSelectionModel().isEmpty()) {
            errorText.setText("Please select a user.");
            return false;
